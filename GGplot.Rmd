...
#label
  geom_label(
    label=round(min(sample_arrange$UQR_sd),digits=1), 
    x=14,
    y=min(sample_arrange$UQR_sd),
    label.size = 0.35,
    color = "black")+
  theme_base()
```
...
<span style="color: green;">This graph shows a significant decrease of ice extent over a 40 year period. The Fall has the most dramatic decrease, which is probably a difficult time for wildlife that rely on ice. </span>
